...
def fill_finance_products(apps, schema_editor):
    ...
    finance_product_model(id=4, name='Факторинг', parent_id=None, lft=1, rght=12, tree_id=8, level=0).save()
    finance_product_model(id=26, name='Классический', parent_id=4, lft=2, rght=3, tree_id=8, level=1).save()
    finance_product_model(id=27, name='Конфиденциальный', parent_id=4, lft=4, rght=5, tree_id=8, level=1).save()
    finance_product_model(id=28, name='Бездокументарный', parent_id=4, lft=6, rght=7, tree_id=8, level=1).save()
    finance_product_model(id=29, name='Безрегрессный', parent_id=4, lft=8, rght=9, tree_id=8, level=1).save()
    finance_product_model(id=30, name='Реверсивный', parent_id=4, lft=10, rght=11, tree_id=8, level=1).save()
