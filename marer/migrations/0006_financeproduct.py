...
def fill_finance_products(apps, schema_editor):
    ...
    finance_product_model(id=40, name='Банки и МФО', parent_id=None, lft=1, rght=52, tree_id=1, level=0).save()
    finance_product_model(id=1, name='Госконтракты', parent_id=40, lft=2, rght=9, tree_id=1, level=1).save()
    ...
    finance_product_model(id=20, name='РКО', parent_id=40, lft=26, rght=27, tree_id=1, level=1).save()
    finance_product_model(id=21, name='Зарплатные проекты', parent_id=40, lft=28, rght=29, tree_id=1, level=1).save()
    finance_product_model(id=22, name='ВЭД', parent_id=40, lft=30, rght=31, tree_id=1, level=1).save()
    finance_product_model(id=3, name='Лизинг', parent_id=40, lft=32, rght=39, tree_id=1, level=1).save()
    finance_product_model(id=23, name='Лизинг автотранспорта', parent_id=3, lft=33, rght=34, tree_id=1, level=2).save()
    finance_product_model(id=24, name='Лизинг оборудования', parent_id=3, lft=35, rght=36, tree_id=1, level=2).save()
    finance_product_model(id=25, name='Лизинг спецтехники', parent_id=3, lft=37, rght=38, tree_id=1, level=2).save()
    finance_product_model(id=4, name='Факторинг', parent_id=40, lft=40, rght=51, tree_id=1, level=1).save()
    finance_product_model(id=26, name='Классический', parent_id=4, lft=41, rght=42, tree_id=1, level=2).save()
    finance_product_model(id=27, name='Конфиденциальный', parent_id=4, lft=43, rght=44, tree_id=1, level=2).save()
    finance_product_model(id=28, name='Бездокументарный', parent_id=4, lft=45, rght=46, tree_id=1, level=2).save()
    finance_product_model(id=29, name='Безрегрессный', parent_id=4, lft=47, rght=48, tree_id=1, level=2).save()
    finance_product_model(id=30, name='Реверсивный', parent_id=4, lft=49, rght=50, tree_id=1, level=2).save()
    finance_product_model(id=5, name='Страхование', parent_id=None, lft=1, rght=12, tree_id=9, level=0).save()
    finance_product_model(id=32, name='Автокредитование', parent_id=5, lft=2, rght=3, tree_id=9, level=1).save()
    finance_product_model(id=33, name='ДМС', parent_id=5, lft=4, rght=5, tree_id=9, level=1).save()
    finance_product_model(id=34, name='Строймонтажные риски', parent_id=5, lft=6, rght=7, tree_id=9, level=1).save()
    finance_product_model(id=36, name='Страхование грузов', parent_id=5, lft=8, rght=9, tree_id=9, level=1).save()
    finance_product_model(id=37, name='Страхование жизни', parent_id=5, lft=10, rght=11, tree_id=9, level=1).save()
