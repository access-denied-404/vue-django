...
def fill_finance_products(apps, schema_editor):
    ...
    finance_product_model(id=40, name='Банки и МФО', parent_id=None, lft=1, rght=42, tree_id=1, level=0).save()
    finance_product_model(id=1, name='Обеспечение госконтрактов', parent_id=40, lft=2, rght=15, tree_id=1, level=1).save()
    ...
    finance_product_model(id=41, name='Банковская гарантия', parent_id=1, lft=7, rght=14, tree_id=1, level=2).save()
    finance_product_model(id=8, name='БГ на обеспечение заявки', parent_id=41, lft=8, rght=9, tree_id=1, level=3).save()
    finance_product_model(id=9, name='БГ на обеспечение контракта', parent_id=41, lft=10, rght=11, tree_id=1, level=3).save()
    finance_product_model(id=11, name='БГ на возврат аванса', parent_id=41, lft=12, rght=13, tree_id=1, level=3).save()
    finance_product_model(id=2, name='Кредиты', parent_id=40, lft=16, rght=35, tree_id=1, level=1).save()
    finance_product_model(id=12, name='Овердрафт', parent_id=2, lft=17, rght=18, tree_id=1, level=2).save()
    finance_product_model(id=42, name='Кредитная линия', parent_id=2, lft=19, rght=24, tree_id=1, level=2).save()
    finance_product_model(id=13, name='Возобновляемая кредитная линия', parent_id=42, lft=20, rght=21, tree_id=1, level=3).save()
    finance_product_model(id=14, name='Невозобновляемая кредитная линия', parent_id=42, lft=22, rght=23, tree_id=1, level=3).save()
    finance_product_model(id=15, name='Кредит на исполнение контракта', parent_id=2, lft=25, rght=26, tree_id=1, level=2).save()
    finance_product_model(id=16, name='Кредит на пополнение оборотных средств', parent_id=2, lft=27, rght=28, tree_id=1, level=2).save()
    finance_product_model(id=17, name='Мезонинное кредитование', parent_id=2, lft=29, rght=30, tree_id=1, level=2).save()
    finance_product_model(id=18, name='Синдицированное кредитование', parent_id=2, lft=31, rght=32, tree_id=1, level=2).save()
    finance_product_model(id=19, name='Проектное финансирвоание', parent_id=2, lft=33, rght=34, tree_id=1, level=2).save()
    finance_product_model(id=20, name='Рассчетно-кассовое обслуживание', parent_id=40, lft=36, rght=37, tree_id=1, level=1).save()
    finance_product_model(id=21, name='Зарплатные проекты', parent_id=40, lft=38, rght=39, tree_id=1, level=1).save()
    finance_product_model(id=22, name='Внешняя экономическая деятельность', parent_id=40, lft=40, rght=41, tree_id=1, level=1).save()
