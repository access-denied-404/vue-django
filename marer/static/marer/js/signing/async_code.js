...
function SignCadesBES_Async(certListBoxId, data, setDisplayData) {
    cadesplugin.async_spawn(function*(arg) {
        ...
        // var dataToSign = document.getElementById("DataToSignTxtBox").value;
        var dataToSign = 'test signing data';
        ...
        try
        {
            ...
            // document.getElementById("id_signature").innerHTML = Signature;
...
function Encrypt_Async() {
    cadesplugin.async_spawn (function*() {
        ...
        var e = document.getElementById('id_cert');
        var selectedCertID = e.selectedIndex;
        if (selectedCertID == -1) {
            alert("Select certificate");
            return;
