...
urlpatterns = [
    ...
    url(r'^rest/issue/(?P<iid>\d+)/generate_doc_ops_mgmt_conclusion_doc$', rest.IssueGenerateDocOpsView.as_view(), name='rest_issue_lawyers_dep_mgmt'),
    url(r'^rest/issue/(?P<iid>\d+)/generate_lawyers_dep_conclusion_doc$', rest.IssueGenerateLawyersDepConclusionDocView.as_view(), name='rest_issue_lawyers_dep_mgmt'),
    url(r'^rest/issue/(?P<iid>\d+)/generate_sec-dep-mgmt$', rest.IssueSecDepMgmtView.as_view(), name='rest_issue_lawyers_dep_mgmt'),
