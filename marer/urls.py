...
urlpatterns = [
    ...
    url(r'^cabinet/requests/(?P<iid>\d+)$', issue.IssueRegisteringView.as_view(), name='cabinet_request'),
    ...
    url(r'^cabinet/requests/(?P<iid>\d+)/adr$', issue.IssueAdditionalDocumentsRequestView.as_view(), name='issue_additional_documents_request'),
