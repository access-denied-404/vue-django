...
class IssueSerializer(ModelSerializer):
    ...
    bg_contract_doc = DocumentSerializer(read_only=True)
    bg_doc = DocumentSerializer(read_only=True)
    transfer_acceptance_act = DocumentSerializer(read_only=True)
    payment_of_fee = DocumentSerializer(read_only=True)
    contract_of_guarantee = ContractOfGuaranteeSerializer(read_only=True)
